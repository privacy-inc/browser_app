...
extension Purchases {
    static let froob = """
By purchasing Privacy + you support research and development at Privacy Inc and for Privacy Browser.

Privacy + is an In-App Purchase, it is non-consumable, meaning it is a 1 time only purchase and you can use it both on iOS and macOS.
"""
    static let why = """
By purchasing Privacy + you are supporting the development and research necessary to fulfil our mission of bringing the most secure and private browser to iOS and macOS.
...
We ask you to purchase Privacy + only if you consider it a good product, if you think is helping you in some way and if you feel the difference between a mainstream browser and Privacy.
